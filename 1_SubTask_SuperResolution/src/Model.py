...
class ConditionalPointHybridLocalGlobalRBF(nn.Module):
    ...
    def __init__(
        ...
        # Optional query-to-latent readout can be used by GL_rbf_ENH for any
        # supported gather mode. The legacy topk_rbf_glres path reuses the same
        # modules and keeps point-feature readout by default for checkpoint shape compatibility.
