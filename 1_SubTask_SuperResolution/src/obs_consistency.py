...
def build_smooth_observation_maps(
    ...
    In the mixed-resolution super-resolution task, coords is the current L/M/H
    sampling coordinate set, so endpoint_smooth naturally follows the selected
    evaluation resolution without changing the training data protocol.
    """
    if sigma <= 0:
