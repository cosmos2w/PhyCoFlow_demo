...
from helpers_V2 import MetricsLogger, TurbulentCombustionH5Dataset, create_recon_dir, visualize_reconstruction, build_sparse_condition
...
class PointCloudFFM(nn.Module):
    ...
    This block now implements 1-Rectified Flow instead of the previous noisy
