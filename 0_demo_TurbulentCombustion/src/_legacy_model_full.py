...
# ---------------------------------------------------------------------------
# Portable GL_rbf_CQ source of truth
# ---------------------------------------------------------------------------
# Keep this historical module import-compatible while ensuring all active
# GL-RBF/CQ construction resolves to the self-contained package implementation.
from phycoflow_pointcloud.models.portable_core import (  # noqa: E402
    CompactLatentReadout as _PortableCompactLatentReadout,
    ConditionalPointHybridLocalGlobalRBF as _PortableGLRBF,
    ConditionalPointHybridLocalGlobalRBFCQ as _PortableGLRBFCQ,
    CrossAttentionBlock as _PortableCrossAttentionBlock,
    FeedForward as _PortableFeedForward,
    FourierPositionalEncoding as _PortableFourierPositionalEncoding,
    PointCloudFFM as _PortablePointCloudFFM,
    SelfAttentionBlock as _PortableSelfAttentionBlock,
    batched_gather_2d as _portable_batched_gather_2d,
    batched_gather_3d as _portable_batched_gather_3d,
    make_mlp as _portable_make_mlp,
)

make_mlp = _portable_make_mlp
FourierPositionalEncoding = _PortableFourierPositionalEncoding
batched_gather_2d = _portable_batched_gather_2d
batched_gather_3d = _portable_batched_gather_3d
FeedForward = _PortableFeedForward
CrossAttentionBlock = _PortableCrossAttentionBlock
CompactLatentReadout = _PortableCompactLatentReadout
SelfAttentionBlock = _PortableSelfAttentionBlock
ConditionalPointHybridLocalGlobalRBF = _PortableGLRBF
ConditionalPointHybridLocalGlobalRBFCQ = _PortableGLRBFCQ
PointCloudFFM = _PortablePointCloudFFM
