#!/usr/bin/env python
"""Regenerate the round-3 coupled-field spacing revision as PDF only."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-id",
        default=f"round3_spacing_{datetime.now():%Y%m%d_%H%M}",
    ...
    command = [
        ...
        "--layout", str(ROOT / "_Scripts/publication_layout_coupled_field_round3_spacing.yaml"),
