#!/usr/bin/env python
"""Regenerate the round-1 Panel-a colorbar/spacing revision as PDF only."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-id",
        default=f"panel_a_round1_{datetime.now():%Y%m%d_%H%M}",
    ...
    command = [
        ...
        "--layout", str(ROOT / "_Scripts/publication_layout_coupled_field_panel_a_round1.yaml"),
