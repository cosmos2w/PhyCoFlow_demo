#!/usr/bin/env python
"""Independent release audit for Figure_MultiFieldReconstruction art V2."""
...
def audit(release: Path) -> dict:
    ...
    required = [
        ...
        release / "source_manifest_art_v2.json", release / "renderer_art_qa.json",
    ]
    ...
    checks = {
        ...
        "compact_height_le_236mm": height_mm <= 236.0,
