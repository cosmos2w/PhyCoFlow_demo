#!/usr/bin/env python
"""Compile delivered V7R2 inserts without retaining a PDF in the release."""
import argparse
import hashlib
import json
...
def main():
    ...
    entry=folder/'si_v7r2_package.tex'
    mainfig=folder/'figure5_v7r2_figure.tex'
...
'''
    ...
    with tempfile.TemporaryDirectory(prefix='figure5_v7r2_tex_') as tmp:
